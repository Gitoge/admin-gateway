...
export class DepartementService {
  protected resourceUrl = this.applicationConfigService.getEndpointForBackend('api/departements');
  protected resourceUrlAll = this.applicationConfigService.getEndpointForBackend('api/allDepartement');
  ...
  queryAll(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IDepartement[]>(this.resourceUrlAll, { params: options, observe: 'response' });
  }
