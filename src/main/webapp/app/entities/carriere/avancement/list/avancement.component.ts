...
export class AvancementComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.avancementService
      ...
      .subscribe({
        next: (res: HttpResponse<IAvancement[]>) => {
  ...
  trackId(_index: number, item: IAvancement): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IAvancement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
