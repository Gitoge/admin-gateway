...
export class NatureActesService {
  // protected resourceUrl = this.applicationConfigService.getEndpointFor('api/nature-actes', 'carriere');
  protected resourceUrl = this.applicationConfigService.getEndpointForCarriere('api/nature-actes');
  ...
  protected convertDateFromClient(natureActes: INatureActes): INatureActes {
    return Object.assign({}, natureActes, {
      userdateInsert: natureActes.userdateInsert?.isValid() ? natureActes.userdateInsert.toJSON() : undefined,
    });
  }
