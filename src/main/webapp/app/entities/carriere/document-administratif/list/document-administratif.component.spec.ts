...
describe('Component Tests', () => {
  describe('DocumentAdministratif Management Component', () => {
    let comp: DocumentAdministratifComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DocumentAdministratifComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.documentAdministratifs?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
