...
export class DocumentAdministratifComponent implements OnInit {
  ...
  delete(documentAdministratif: IDocumentAdministratif): void {
  ...
  protected onSuccess(data: IDocumentAdministratif[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/document-administratif'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
    ...
    this.documentAdministratifs = data ?? [];
