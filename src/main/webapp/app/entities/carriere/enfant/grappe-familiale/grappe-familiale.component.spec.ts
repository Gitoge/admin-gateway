...
import { GrappeFamilialeComponent } from './grappe-familiale.component';

describe('Enfant Management Update Component', () => {
  let comp: GrappeFamilialeComponent;
  let fixture: ComponentFixture<GrappeFamilialeComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [GrappeFamilialeComponent],
      providers: [
        FormBuilder,
        {
      ...
      .overrideTemplate(GrappeFamilialeComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(GrappeFamilialeComponent);
