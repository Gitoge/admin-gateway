...
export class ParametreComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.parametreService
      ...
      .subscribe({
        next: (res: HttpResponse<IParametre[]>) => {
  ...
  trackId(_index: number, item: IParametre): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IParametre[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
