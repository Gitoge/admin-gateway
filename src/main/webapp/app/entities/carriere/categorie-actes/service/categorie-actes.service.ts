...
export class CategorieActesService {
  // protected resourceUrl = this.applicationConfigService.getEndpointFor('api/categorie-actes', 'carriere');
  protected resourceUrl = this.applicationConfigService.getEndpointForCarriere('api/categorie-actes');
  ...
  protected convertDateFromClient(categorieActes: ICategorieActes): ICategorieActes {
    return Object.assign({}, categorieActes, {
      userdateInsert: categorieActes.userdateInsert?.isValid() ? categorieActes.userdateInsert.toJSON() : undefined,
    });
  }
