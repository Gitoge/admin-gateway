...
import { PriseEnCompteUpdateComponent } from './prise-en-compte-update.component';

describe('PriseEnCompte Management Update Component', () => {
  let comp: PriseEnCompteUpdateComponent;
  let fixture: ComponentFixture<PriseEnCompteUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [PriseEnCompteUpdateComponent],
      providers: [
        FormBuilder,
        {
      ...
      .overrideTemplate(PriseEnCompteUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(PriseEnCompteUpdateComponent);
