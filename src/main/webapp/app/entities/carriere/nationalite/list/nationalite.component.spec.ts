...
describe('Nationalite Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'nationalite', component: NationaliteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.nationalites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
