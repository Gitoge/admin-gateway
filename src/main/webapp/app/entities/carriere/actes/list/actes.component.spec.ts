...
describe('Actes Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'actes', component: ActesComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.actes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
