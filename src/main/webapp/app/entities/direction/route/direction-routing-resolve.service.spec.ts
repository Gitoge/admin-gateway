...
describe('Direction routing resolve service', () => {
  ...
  let resultDirection: IDirection | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IDirection if id is not provided', () => {
      // GIVEN
      ...
      expect(resultDirection).toEqual(new Direction());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Direction })));
      mockActivatedRouteSnapshot.params = { id: 123 };
