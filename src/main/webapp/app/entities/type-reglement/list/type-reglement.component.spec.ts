...
describe('TypeReglement Management Component', () => {
  let comp: TypeReglementComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TypeReglementComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.typeReglements[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
