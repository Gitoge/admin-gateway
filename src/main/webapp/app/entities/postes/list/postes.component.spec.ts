...
describe('Postes Management Component', () => {
  let comp: PostesComponent;
  let fixture: ComponentFixture<PostesComponent>;
  let service: PostesService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'postes', component: PostesComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PostesComponent, '')
      .compileComponents();
