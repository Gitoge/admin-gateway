...
export class PostesComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.postesService
      .findPostesByMotsCles(this.motCles, {
        page: pageToLoad - 1,
  ...
  trackId(_index: number, item: IPostes): number {
    return item.id!;
  }

  delete(postes: IPostes): void {
    const modalRef = this.modalService.open(PostesDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.postes = postes;
