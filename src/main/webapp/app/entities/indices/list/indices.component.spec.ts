...
describe('Indices Management Component', () => {
  let comp: IndicesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(IndicesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.indices[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
