...
describe('Profils Management Component', () => {
  let comp: ProfilsComponent;
  let fixture: ComponentFixture<ProfilsComponent>;
  let service: ProfilsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'profils', component: ProfilsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ProfilsComponent, '')
      .compileComponents();
