...
describe('FichePaie Management Component', () => {
  let comp: FichePaieComponent;
  let fixture: ComponentFixture<FichePaieComponent>;
  let service: FichePaieService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fiche-paie', component: FichePaieComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FichePaieComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fichePaies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
