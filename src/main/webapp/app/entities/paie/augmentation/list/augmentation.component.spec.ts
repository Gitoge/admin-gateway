...
describe('Augmentation Management Component', () => {
  let comp: AugmentationComponent;
  let fixture: ComponentFixture<AugmentationComponent>;
  let service: AugmentationService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'augmentation', component: AugmentationComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AugmentationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.augmentations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
