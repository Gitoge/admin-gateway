...
import { IPosteCompoGrade, getPosteCompoGradeIdentifier } from '../poste-compo-grade.model';
...
export class PosteCompoGradeService {
  protected resourceUrl = this.applicationConfigService.getEndpointForPaie('api/poste-compo-grade');
