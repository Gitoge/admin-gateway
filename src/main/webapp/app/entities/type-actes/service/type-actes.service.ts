...
export class TypeActesService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/type-actes');
  ...
  protected convertDateFromClient(typeActes: ITypeActes): ITypeActes {
    return Object.assign({}, typeActes, {
      userdateInsert: typeActes.userdateInsert?.isValid() ? typeActes.userdateInsert.format(DATE_FORMAT) : undefined,
    });
  }
