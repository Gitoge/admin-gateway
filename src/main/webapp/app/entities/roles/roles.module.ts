...
import { PagesActionsRoleComponent } from './pages_actions_role/pages_actions_role.component';

@NgModule({
  imports: [SharedModule, RolesRoutingModule],
  declarations: [RolesComponent, RolesDetailComponent, RolesUpdateComponent, RolesDeleteDialogComponent, PagesActionsRoleComponent],
