...
describe('Positions Management Component', () => {
  let comp: PositionsComponent;
  let fixture: ComponentFixture<PositionsComponent>;
  let service: PositionsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'positions', component: PositionsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PositionsComponent, '')
      .compileComponents();
