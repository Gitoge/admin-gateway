...
export class RegionService {
  protected resourceUrl = this.applicationConfigService.getEndpointForBackend('api/regions');
  protected resourceUrlAll = this.applicationConfigService.getEndpointForBackend('api/allRegion');
  ...
  queryAll(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IRegion[]>(this.resourceUrlAll, { params: options, observe: 'response' });
  }
